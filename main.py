        ...
        def func():
            ...
            while not self.stop_program :
                ...
                if text in self.analyzer.errors :
                    ...
                    answer = self.analyzer.answer( text , text)
                    ...
                    answer = self.analyzer.answer(self.current_activity , text)

                    # -----> Displaying the result in UI
                    self.conversations.addChat(answer)
                    self.doTalking(answer)

                    # -----> Add the data to future learning
                    self.new_data_handler.add_new_data(self.current_activity , text)
